...
programming with Minecraft](https://ropenscilabs.github.io/miner_book).
...
* Take an image (like a [photo](https://ropenscilabs.github.io/miner_book/rendering-an-image-in-minecraft.html) or
  [logo](https://ropenscilabs.github.io/miner_book/rendering-the-r-logo-in-minecraft.html)),
  and create a wall ([like this](https://ropenscilabs.github.io/miner_book/figure/karthik_minecraft.png)) in Minecraft that looks like the image.
* Build a [random
  maze](https://ropenscilabs.github.io/miner_book/generate-a-maze-in-minecraft.html)
  ([like this](https://ropenscilabs.github.io/miner_book/figure/maze-minecraft.png)) to explore in Minecraft.
* Create a
[staircase](https://ropenscilabs.github.io/miner_book/a-stairway-to-heaven.html) or
  [tower](https://ropenscilabs.github.io/miner_book/building-a-tower-and-jumping-on-top.html) programatically.
...
* Track the player's actions to have them [plant flowers](https://ropenscilabs.github.io/miner_book/planting-a-garden.html)
  or [build an ice tower](https://ropenscilabs.github.io/miner_book/planting-a-garden.html#build-ice-towers).
* Write a bot to [play a game with players over chat](https://ropenscilabs.github.io/miner_book/number-guess-chat-bot-in-minecraft.html) or
  [evaluate R commands](https://github.com/ropenscilabs/craft/blob/master/R/mc_Reval.R).

Many of these features have been integrated into the companion
package, [craft](https://github.com/ropenscilabs/craft). We are also
preparing an ebook, [R programming with
Minecraft](https://ropenscilabs.github.io/miner_book/), which
...
with Minecraft](https://ropenscilabs.github.io/miner_book/).
